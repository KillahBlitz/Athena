...
CREATE TABLE public.subhabilidad (
    id_subhabilidad INTEGER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    nombre_subhabilidad VARCHAR(150) NOT NULL,
    id_habilidad INTEGER NOT NULL,
    CONSTRAINT fk_subhabilidad_habilidad
        FOREIGN KEY (id_habilidad) REFERENCES public.habilidad (id_habilidad)
);
